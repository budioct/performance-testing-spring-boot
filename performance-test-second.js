...
// Custom metrics
const errorRateTwo = new Rate('errors');
...
export default function () {
    ...
    const response = http.get('http://localhost:8080/api/v1/schools/list-dto');

    // Record errors for custom metric
    errorRateTwo.add(response.status !== 200);
...
export function setup() {
    ...
    console.log('Target: http://localhost:8080/api/v1/schools/list-dto');
